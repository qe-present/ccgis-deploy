...
import getStatationInfo from "src/utils/GetStatationInfo.js";
...
const addPositionToMap = (result) => {
  let map = busStore.getMap()
  let markerLayer = busStore.getMarkerLayer()
...
const getFocus = (type) => {
  switch (type) {
    case 'start':
      endSuggestions.value = false;
      startSuggestions.value = true;
      break;
    case 'end':
      startSuggestions.value = false;
      endSuggestions.value = true;
      break;
    default:
      break;
  }
...
<template>
  <q-item clickable v-ripple>
    ...
    <q-item-section>
      ...
      <q-input type="text" :disable="true" v-if="busStore.getStartSure" v-model="busStore.getStartName"></q-input>
    </q-item-section>
  </q-item>
  <q-item clickable v-ripple>
    <q-item-section avatar class="text-purple q-gutter-md">
  ...
  <q-item clickable v-ripple>
    ...
    <q-item-section>
      ...
      <q-input type="text" :disable="true" v-if="busStore.getEndSure" v-model="busStore.getEndName"></q-input>
    </q-item-section>
  </q-item>
  <q-item clickable v-ripple>
    <q-item-section avatar class="text-purple q-gutter-md">
  ...
  <Bustable v-model:dialog="showStart" v-model:tableData="tableData" v-if="flagStart" v-model:flag="flagStart"
            :need="'Start'"></Bustable>
  <Bustable v-model:dialog="showEnd" v-model:tableData="tableData" v-if="flagEnd" v-model:flag="flagEnd"
            :need="'End'"></Bustable>
</template>
